  ...
  $(document).ready(function() {
    ...
    $('.postTypeInputBox').change(function(e){
      ...
      if(this.checked) {
        ...
        $(this).closest('.postTyperow').find('.fetch-data').find('.all-section input').prop('checked',true)
    }else{
      let postTypeToHide = $(this).closest('.postTyperow').find('.fetch-data');
      $(postTypeToHide).find('.all-section input').prop('checked',false);
      $(postTypeToHide).find('.id-specific-section ul li').each(function (index, value){
        $(value).remove();
      })
      $(postTypeToHide).hide();
    }
